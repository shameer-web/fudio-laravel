										...
										<table class="table table-separate table-head-custom table-checkable" id="kt_datatable">
											...
											<tbody>
												...
												<tr>
                                                   ...
                                                   <img src="{{ url('assets/image/vendor/vendor/'.$row->vendor_image)}}" alt="" width="100px" height="100px">

                                               
													</td>

                                                    <td>{{ $row->license_certification_number}}</td>
                                                    ...
                                                    <td>
                                                    	...
                                                    	{{-- <a href="{{ route('vendor.show',$row->id) }}">
                                                    	...
                                                    	<a href="{{ route('vendor.edit',$row->id) }}"
                                                            ...
                                                            <input type="submit" class="btn btn-danger" value="Delete"/>
                                                             ...
                                                             <button type="button" id="deletebtn"
                                                              data-action="{{route('vendor.update',$row->id)}}" data-toggle="modal"
                    ...
                    <form id="delete_form" action="" method="post" class="form-horizontal">
                        ...
                        <div class="modal-content">
                            <div class="alert alert-danger" role="alert" style="margin-bottom: 0px">
                                ...
                                <input type="hidden" name="vendor_status" value="0">
                            </div>
                        </div>
                    </form>
                </div>
