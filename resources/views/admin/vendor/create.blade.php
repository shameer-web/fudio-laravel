							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-2 mr-5">Create Vendor </h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
												...
												<div class="card-body">
													...
													<div class="form-group row">
														...
														<div class="col-lg-6">
															...
															<input type="text" name="email" class="form-control" placeholder="Enter vendor name" />
                                                       ...
                                                       @error('email')
														...
														<div class="col-lg-6">
															...
															<input type="password" class="form-control" name="password" placeholder="Enter Skills" />
 ...
 --}}
												 ...
												 @enderror
													...
													<div class="form-group row">
														...
														<div class="col-lg-6">
															<label>PinCode:</label>
															<div class="input-group">
																<input type="text" name="pincode" class="form-control" placeholder="Enter your address" />
													...
													<div class="form-group row">
														<div class="col-lg-6">
															...
															<input type="text" name="land_phone" class="form-control" placeholder="Enter land phone number" />
													...
													<div class="form-group row">
														...
														<div class="col-lg-6">
															...
															<input type="text"  name="delivery_charge"class="form-control" placeholder="Enter delivery charge" />
													...
													<div class="form-group row">
														...
														<div class="col-lg-6">
															...
															<input type="text" name="packing_charge" class="form-control" placeholder="Enter packing charge" />
													...
													<div class="form-group row">
														...
														<div class="col-lg-6">
															...
															<input type="text" name="minimum_delivery_time" class="form-control" placeholder="Enter minimum delivery time" />

														@error('minimum_delivery_time')
														<p class="text-danger">{{ $message }}</p>
														@enderror
														...
														<div class="col-lg-6">
															...
															<input type="text"  name="license_certification_number"class="form-control"  placeholder="Enter distance" />


														@error('license_certification_number')
														<p class="text-danger">{{ $message }}</p>
														@enderror
                        ...
                        <div class="form-group">
							<label>Google Address</label>
								<div class="input-group">
									<input type="text" name="google_address" id="autocomplete" class="form-control" placeholder="Enter google_address" />
