								...
								<div class="card card-custom">
									<div class="card-header flex-wrap py-5">
										<div class="card-title">
											<h3 class="card-label">Offer Table
											</h3>
										</div>
										...
										<table class="table table-separate table-head-custom table-checkable" id="kt_datatable">
											...
											<tbody>
												...
												<tr>
													<td>{{ ++$i }}</td>
													<td> 
                                                    {{-- <img src="{{ asset('/storage/images/'.$row->banner) }}" alt="" width="100px" height="100px"> --}}

                                                     <img src="{{ url('assets/image/offer/banners/'.$row->banner)}}" alt="" width="100px" height="100px">
                                                    	...
                                                    	<a href="{{ route('offer.edit',$row->id) }}"
                                                            ...
                                                            class="fa fa-edit" aria-hidden="true"></i>
                                                             ...
                                                             <button type="button" id="deletebtn"
                                                              data-action="{{route('offer.update',$row->id)}}" data-toggle="modal"
                    ...
                    <form id="delete_form" action="" method="post" class="form-horizontal">
                        ...
                        <div class="modal-content">
                            <div class="alert alert-danger" role="alert" style="margin-bottom: 0px">
                                ...
                                <input type="hidden" name="offer_status" value="0">
                            </div>
                        </div>
                    </form>
                </div>
