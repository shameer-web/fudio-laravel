							...
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline mr-5">
										<!--begin::Page Title-->
										<h2 class="subheader-title text-dark font-weight-bold my-2 mr-3">Edit Menu</h2>
										<!--end::Page Title-->
											...
											<form action="{{ route('menu.update',$edit->id) }}" method="post" enctype="multipart/form-data">
												...
												<div class="card-body">
													...
													<div class="form-group">
														...
														<input type="hidden" name="vendor_id" value="{{ $edit->vendor_id }}" class="form-control" placeholder="Enter  Item Name" />
